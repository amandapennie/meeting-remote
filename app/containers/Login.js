...
export class ProviderLoginView extends React.Component {
  ...
  getAuthorizeUri() {
    return `https://api.getgo.com/oauth/v2/authorize?client_id=${Config.GTM_CONSUMER_KEY}&response_type=code&state=mr&redirect_uri=${encodeURIComponent(REDIRECT_URI)}`;
  }
